...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="/Home" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-danger"><i class="fa fa-book me-3"></i>KaryaSiswa</h2>
        </a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-danger px-3">KOntak Kami</h6>
                <h1 class="mb-5">Kontak Jika Ada Keperluan</h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-danger w-100 py-3" style="border-radius: 30px 30px 30px 30px;"type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
