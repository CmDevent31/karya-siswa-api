...
<div class="container ">
    ...
    <div class="col-lg-15">
        <div class="row row-cols-1 row-cols-md-3 g-4 mt-3 rounded">
            ...
            <div class="col">
                <div class="card text-center h-100 mb-3">
                  <img src="https://www.freecodecamp.org/news/content/images/2021/02/fireship-cookies.png" class="img-fluid rounded-top" alt="Responsive image" style="object-fit: cover">
                  <div class="card-body">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link text-danger active" href="/PrivacyPolicy">Privacy Policy</a>
